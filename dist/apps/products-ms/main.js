...
let TypeormProductsReferenceLookupAdapter = class TypeormProductsReferenceLookupAdapter {
    ...
    async get_partner_name_by_internal_id(internal_id) {
        const rows = await this.data_source.query(`SELECT alias FROM suppliers_schema.partners WHERE id = $1 LIMIT 1`, [internal_id]);
...
class CategoryMapper {
    ...
    static from_raw_row(row) {
        ...
        const credit_facility_id = cf_raw === null || cf_raw === undefined ? null : Number(cf_raw);
        return new category_models_1.Category(Number(row['id']), String(row['external_id']), credit_facility_id, row['partner_id'] === null || row['partner_id'] === undefined
            ? null
...
let TypeormCategoryRepository = class TypeormCategoryRepository {
    ...
    async update_by_external_id(external_id, patch) {
        ...
        if (patch.credit_facility_id !== undefined) {
            await this.repo.query(`INSERT INTO products_schema.client_category_assignments (credit_facility_id, category_id)
         VALUES ($1, $2)
         ON CONFLICT (category_id) DO UPDATE
         SET credit_facility_id = EXCLUDED.credit_facility_id`, [patch.credit_facility_id, existing.id]);
        }
        const columns = [];
        const values = [];
        let i = 1;
...
const common_1 = __webpack_require__(/*! @nestjs/common */ "@nestjs/common");
const config_1 = __webpack_require__(/*! @nestjs/config */ "@nestjs/config");
const client_scheduler_1 = __webpack_require__(/*! @aws-sdk/client-scheduler */ "@aws-sdk/client-scheduler");
...
async function build_category_public_fields(row, lookup) {
    const credit_facility_external_id = row.credit_facility_id === null
        ? null
        : await lookup.get_credit_facility_external_id_by_internal_id(row.credit_facility_id);
    const partner_external_id = row.partner_id === null
        ? null
        : await lookup.get_partner_external_id_by_internal_id(row.partner_id);
    if ((row.credit_facility_id !== null && credit_facility_external_id === null) ||
...
class RegisterNaturalPersonCreditApplicationRequest {
    ...
    totalAssets;
    partnerCategoryIds;
    constructor(birthDate, businessAddress, businessFlagshipM2, businessName, businessRentAmount, businessSeniority, businessType, cityId, currentPurchases, docNumber, docType, email, firstName, lastName, monthlyExpenses, monthlyIncome, monthlyPurchases, numberOfEmployees, numberOfLocations, partnerId, salesRepId, privacyPolicyAccepted, phone, relationshipToBusiness, requestedCreditLine, totalAssets, partnerCategoryIds) {
        this.birthDate = birthDate;
        this.businessAddress = businessAddress;
        this.businessFlagshipM2 = businessFlagshipM2;
        this.businessName = businessName;
...
let RegisterNaturalPersonCreditApplicationUseCase = class RegisterNaturalPersonCreditApplicationUseCase {
    ...
    publish_authorization_notification;
    config_service;
    constructor(credit_application_repository, client_registration, products_lookup, create_person_sqs_result, category_repository, publish_create_person, publish_authorization_notification, config_service) {
        this.credit_application_repository = credit_application_repository;
        this.client_registration = client_registration;
        this.products_lookup = products_lookup;
    ...
    async execute(req) {
        ...
        for (const cat_external_id of req.partnerCategoryIds) {
            ...
            if (!category) {
                throw new common_1.BadRequestException(`categoría no encontrada: ${cat_external_id}`);
            }
            if (category.partner_id !== partner_internal_id) {
                throw new common_1.BadRequestException(`categoría ${cat_external_id} no pertenece al partner indicado`);
            }
        ...
        const created = await this.credit_application_repository.create({
            ...
            status: shared_1.CreditApplicationStatus.PENDING_AUTHORIZATION,
        ...
        const partner_name = await this.products_lookup.get_partner_name_by_internal_id(partner_internal_id);
...
exports.RegisterNaturalPersonCreditApplicationUseCase = RegisterNaturalPersonCreditApplicationUseCase = __decorate([
    ...
    __param(4, (0, common_1.Inject)(categories_tokens_1.CATEGORY_REPOSITORY)),
    __metadata("design:paramtypes", [typeof (_a = typeof credit_application_ports_1.CreditApplicationRepository !== "undefined" && credit_application_ports_1.CreditApplicationRepository) === "function" ? _a : Object, typeof (_b = typeof client_registration_port_1.ClientRegistrationPort !== "undefined" && client_registration_port_1.ClientRegistrationPort) === "function" ? _b : Object, Object, Object, Object, typeof (_c = typeof publish_create_person_command_use_case_1.PublishCreatePersonCommandUseCase !== "undefined" && publish_create_person_command_use_case_1.PublishCreatePersonCommandUseCase) === "function" ? _c : Object, typeof (_d = typeof publish_authorization_notification_use_case_1.PublishAuthorizationNotificationUseCase !== "undefined" && publish_authorization_notification_use_case_1.PublishAuthorizationNotificationUseCase) === "function" ? _d : Object, typeof (_e = typeof config_1.ConfigService !== "undefined" && config_1.ConfigService) === "function" ? _e : Object])
...
var credit_application_job_port_1 = __webpack_require__(/*! ./domain/ports/credit-application-job.port */ "./apps/products-ms/src/modules/credit-applications/domain/ports/credit-application-job.port.ts");
...
/***/ "./apps/products-ms/src/modules/credit-applications/domain/ports/credit-application-job.port.ts"
/*!******************************************************************************************************!*\
  !*** ./apps/products-ms/src/modules/credit-applications/domain/ports/credit-application-job.port.ts ***!
  \******************************************************************************************************/
(__unused_webpack_module, exports) {
...
], CreateNaturalPersonCreditApplicationDto.prototype, "partnerCategoryIds", void 0);
__decorate([
    (0, swagger_1.ApiProperty)({
...
__decorate([
    (0, swagger_1.ApiPropertyOptional)({ description: 'Aceptación explícita de la política de privacidad' }),
    (0, class_validator_1.IsOptional)(),
    (0, class_validator_1.IsBoolean)(),
    __metadata("design:type", Boolean)
...
/*!********************************************!*\
  !*** external "@aws-sdk/client-scheduler" ***!
  \********************************************/
(module) {
