export declare const PARTNER_ONBOARDING_SAGA_REPOSITORY: unique symbol;
export type PartnerOnboardingSagaStatus = 'RUNNING' | 'COMPLETED' | 'FAILED' | 'COMPENSATING';
...
export type PartnerOnboardingSagaPatch = Partial<Pick<PartnerOnboardingSagaRecord, 'status' | 'current_step' | 'credit_facility_external_id' | 'user_external_id' | 'person_external_id' | 'business_external_id' | 'bank_account_external_id' | 'partner_external_id' | 'error_message'>>;
