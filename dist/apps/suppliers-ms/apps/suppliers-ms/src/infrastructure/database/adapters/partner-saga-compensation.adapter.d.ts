...
export declare class PartnerSagaCompensationAdapter implements PartnerSagaCompensationPort {
    ...
    constructor(data_source: DataSource, partner_repo: Repository<PartnersEntity>, supplier_repo: Repository<SupplierEntity>, business_repo: Repository<BusinessEntity>, bank_account_repo: Repository<BankAccountEntity>);
