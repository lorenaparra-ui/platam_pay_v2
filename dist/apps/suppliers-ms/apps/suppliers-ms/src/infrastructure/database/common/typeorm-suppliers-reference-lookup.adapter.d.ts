...
import { BankAccountEntity, BusinessEntity, PartnersEntity, SupplierEntity } from '@app/suppliers-data';
export declare class TypeormSuppliersReferenceLookupAdapter implements SuppliersReferenceLookupPort {
    ...
    constructor(users: Repository<UserEntity>, persons: Repository<PersonEntity>, cities: Repository<CityEntity>, businesses: Repository<BusinessEntity>, bank_accounts: Repository<BankAccountEntity>, partners: Repository<PartnersEntity>, suppliers: Repository<SupplierEntity>);
