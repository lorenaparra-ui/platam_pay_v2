...
import { CreditApplicationBnplController } from "./presentation/credit-application-bnpl.controller";
...
@Module({
  ...
  controllers: [CreditApplicationBnplController],
  providers: [
    {
...
export class CreditApplicationsBnplModule {}
