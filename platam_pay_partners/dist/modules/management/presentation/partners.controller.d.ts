...
import { RegisterPartnerRequestDto } from "../application/dto/register-partner-request.dto";
...
import { RegisterPartnerUseCase } from "../application/use-cases/register-partner.use-case";
...
export declare class PartnersController {
    ...
    private readonly registerPartnerUseCase;
    ...
    constructor(createPartnerUseCase: CreatePartnerUseCase, registerPartnerUseCase: RegisterPartnerUseCase, findAllPartnersUseCase: FindAllPartnersUseCase, findPartnerByExternalIdUseCase: FindPartnerByExternalIdUseCase, updatePartnerByExternalIdUseCase: UpdatePartnerByExternalIdUseCase, deletePartnerByExternalIdUseCase: DeletePartnerByExternalIdUseCase, changePartnerStatusUseCase: ChangePartnerStatusUseCase);
    registerFull(body: RegisterPartnerRequestDto, files?: {
        logo?: {
            buffer: Buffer;
            mimetype: string;
        }[];
