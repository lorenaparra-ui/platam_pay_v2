...
class CategoryMapper {
    static to_domain(entity) {
        return {
            ...
            partner_id: entity.partnerId != null ? Number(entity.partnerId) : null,
            name: entity.name,
            discount_percentage: String(entity.discountPercentage),
            interest_rate: String(entity.interestRate),
            disbursement_fee_percent: entity.disbursementFeePercent != null
                ? String(entity.disbursementFeePercent)
                : null,
            minimum_disbursement_fee: entity.minimumDisbursementFee != null
