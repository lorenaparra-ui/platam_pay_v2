...
let TypeOrmCreditApplicationBnplRepository = class TypeOrmCreditApplicationBnplRepository {
    ...
    async create(input) {
        const entity = credit_application_bnpl_mapper_1.CreditApplicationBnplMapper.toEntityFromCreateInput(input);
    ...
    async updateByExternalId(externalId, input) {
        ...
        if (input.userProductId !== undefined)
            entity.userProductId = input.userProductId;
        ...
        if (input.salesRepId !== undefined)
            entity.salesRepId = input.salesRepId;
        ...
        return updated ? credit_application_bnpl_mapper_1.CreditApplicationBnplMapper.toDomain(updated) : null;
    }
