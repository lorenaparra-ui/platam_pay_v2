...
export declare const BACKOFFICE_CREDIT_APPLICATIONS_READ_REPOSITORY = "BACKOFFICE_CREDIT_APPLICATIONS_READ_REPOSITORY";
export type BackofficeCreditApplicationsSortBy = "most_recent" | "oldest" | "requested_credit_line_desc" | "requested_credit_line_asc" | "queue_days_desc";
