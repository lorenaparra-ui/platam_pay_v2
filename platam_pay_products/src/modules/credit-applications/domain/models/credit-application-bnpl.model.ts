/**
 * Modelo de dominio para solicitud de crédito BNPL.
 * Alineado con tabla credit_applications_bnpl.
 * Valores monetarios y montos en centavos/unidad mínima (evitar number flotante).
 */
export interface CreditApplicationBnpl {
  id: number;
  externalId: string;
  userId: number;
