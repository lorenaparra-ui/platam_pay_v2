...
const partner_logo_upload_handler_1 = require("./infrastructure/handlers/partner-logo-upload.handler");
const partner_categories_create_handler_1 = require("./infrastructure/handlers/partner-categories-create.handler");
const partner_user_create_handler_1 = require("./infrastructure/handlers/partner-user-create.handler");
...
const partner_categories_service_stub_adapter_1 = require("./infrastructure/adapters/partner-categories-service-stub.adapter");
const partner_user_creator_stub_adapter_1 = require("./infrastructure/adapters/partner-user-creator-stub.adapter");
...
exports.PartnersModule = PartnersModule = __decorate([
    (0, common_1.Module)({
        ...
        providers: [
            ...
            { provide: file_uploader_port_1.FILE_UPLOADER, useClass: in_memory_file_uploader_adapter_1.InMemoryFileUploaderAdapter },
            ...
            {
                provide: partner_categories_service_port_1.PARTNER_CATEGORIES_SERVICE,
                useClass: partner_categories_service_stub_adapter_1.PartnerCategoriesServiceStubAdapter,
            },
            { provide: partner_user_creator_port_1.PARTNER_USER_CREATOR, useClass: partner_user_creator_stub_adapter_1.PartnerUserCreatorStubAdapter },
