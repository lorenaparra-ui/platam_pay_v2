...
exports.OnboardingMapper = void 0;
const onboarding_model_1 = require("../../../modules/onboarding/domain/models/onboarding.model");
const database_1 = require("@libs/database");
class OnboardingMapper {
    static toDomain(entity) {
        return new onboarding_model_1.Onboarding({
            id: entity.id,
    ...
    static toEntity(domain) {
        const entity = new database_1.OnboardingEntity();
        entity.id = domain.id;
...
exports.OnboardingMapper = OnboardingMapper;
