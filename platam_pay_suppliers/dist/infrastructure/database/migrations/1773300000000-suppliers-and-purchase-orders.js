...
exports.SuppliersAndPurchaseOrders1773300000000 = void 0;
class SuppliersAndPurchaseOrders1773300000000 {
    ...
    `);
        if (Array.isArray(partnersFkDefaultCategory) && partnersFkDefaultCategory.length > 0) {
            ...
            if (name) {
                await queryRunner.query(`ALTER TABLE "partners" DROP CONSTRAINT IF EXISTS "${name}"`);
            }
        }
        await queryRunner.query(`ALTER TABLE "partners" DROP COLUMN IF EXISTS "default_category_id"`);
        await queryRunner.query(`DROP TABLE IF EXISTS "partner_categories" CASCADE`);
        await queryRunner.query(`DROP TABLE IF EXISTS "credit_applications_bnpl" CASCADE`);
    }
...
exports.SuppliersAndPurchaseOrders1773300000000 = SuppliersAndPurchaseOrders1773300000000;
//# sourceMappingURL=1773300000000-suppliers-and-purchase-orders.js.map