export class UpdatePartnerByExternalIdRequest {
  constructor(
    ...
    readonly business_external_id: string | undefined,
    ...
    readonly sales_rep_role_name: string | null | undefined,
    readonly sales_rep_role_name_plural: string | null | undefined,
