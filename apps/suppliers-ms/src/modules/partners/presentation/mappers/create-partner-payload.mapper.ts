import type {
  CreatePartnerBusinessPayloadDto,
  CreatePartnerPayloadDto,
} from '../dto/create-partner-payload.dto';
...
function trim_or_null(s: string | null | undefined): string | null {
...
function pick_city_external_id_from_business(
  b: CreatePartnerBusinessPayloadDto,
): string | null {
...
/** Acepta string (HTTP) o número (clientes legacy). */
function phone_from_payload(
...
export function map_create_partner_payload_to_command(
  ...
  return {
    ...
    disbursement_notification_email:
      dto.partner.disbursementNotificationEmail ?? null,
    ...
    categories: dto.category.map((c) => ({
      ...
      disbursement_fee_percent:
        c.disbursementFeePercent !== null && c.disbursementFeePercent !== undefined
          ? String(c.disbursementFeePercent)
          : null,
      minimum_disbursement_fee:
        c.minimumDisbursementFee !== null && c.minimumDisbursementFee !== undefined
