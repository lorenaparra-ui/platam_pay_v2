export class Partner {
  constructor(
    ...
    readonly sales_rep_role_name: string | null,
    readonly sales_rep_role_name_plural: string | null,
    readonly api_key_hash: boolean,
    ...
    readonly default_rep_id: number | null,
...
export type UpdatePartnerProps = Partial<CreatePartnerProps>;
